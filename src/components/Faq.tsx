            ...
            <div className={classes.txt}>
              ...
              >
                <AccordionSummary
                  expandIcon={
                    expanded === "panel1" ? (
                      <RemoveIcon sx={{ color: "#784dc8" }} />
                    ) : (
                      <AddIcon sx={{ color: "#784dc8" }} />
                    )
                  }
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WHAT IS THE TOTAL SUPPLY OF BORED 90s GANG?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    There are a total of 8896 Bored 90s Gangster NFTs available
                    to mint:
                    <p>- 8888 Regular Bored 90s Gangsters</p>- 8 ultra-rare OGs,
                    which come with added rewards and incredible rarity. You
                    have approximately a 0.1% chance to mint an OG.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
          ...
          <div className={classes.faqitem}>
            <div className={classes.txt}>
              ...
              >
                ...
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    Yes, we will be holding a presale 1 day prior to the public
                    sale launch for our whitelist members.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WHAT IS THE PRICE FOR ONE BORED 90s GANG NFT?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    For the whitelist presale the price will be set at 0.1 ETH +
                    Gas
                    <p>
              ...
              >
                ...
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    ...
                    on the blockchain. This unique digital asset has verifiable
                    uniqueness, rarity and proof-of-ownership. The Bored 90s
                    Gang NFT tokens are Ethereum ERC-721 tokens.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WHAT DAY DOES BORED 90s GANG LAUNCH?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
          ...
          <div className={classes.faqitem}>
            <div className={classes.txt}>
              ...
              >
                ...
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    To mint a Bored 90s Gang NFT, you will need to obtain
                    Ethereum tokens and transfer them into your crypto wallet
                    (preferably metamask due to security and ease of use). Once
                    you have done this, connect your metamask wallet to your
                    internet browser and integrate it into our website and you
                    will be able to mint your Bored 90s Gang NFT!
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    CAN I MINT USING MY PHONE?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    If you are using a mobile phone to mint a Bored 90s
                    Gangster, you need to use the Metamask application built-in
                    browser.
                    <p>
                      - Please launch the Metamask application, click the 3
                      lines on the top left menu in the application and select
                      "Browser".
                    </p>
                    - It will open a web browser and you will be able to
                    navigate back to WEBSITE LINK to do the minting.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    HOW CAN I GET ONTO THE WHITELIST?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    HOW MANY BORED 90s GANG NFTS CAN I MINT IN THE PUBLIC SALE?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    There is a limit of 3 NFTs per wallet if you are in the
                    public sale.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WHAT HAPPENS IF I MISS THE WHITELIST AND PUBLIC SALE?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WHERE CAN I VIEW MY BORED 90s GANG NFT?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    Once you have minted your Bored 90s Gang NFT, you will be
                    able to view it when you connect your crypto wallet to
                    OpenSea.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WHAT CAN I DO WITH MY BORED 90S GANGSTER NFT?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    You can use your Bored 90s Gang NFT as a profile picture
                    online, and hold until we airdrop the 3D collection. Holding
                    long-term is the way to get the most value out of your NFT,
                    as well as the added utility that will come when we begin
                    our metaverse integration project.
                    <p>
                      However, we understand that some in the NFT space aim to
                      flip NFT’s by buying them and selling them for profit.
                      This is entirely your right to do so, however if you are
                      not holding a your Bored 90s Gangster NFT on 3D Airdrop
                      day, you will not receive your 3D NFT.
                    </p>
                  </Typography>
                </AccordionDetails>
              </Accordion>
          ...
          <div className={classes.faqitem}>
            <div className={classes.txt}>
              ...
              >
                ...
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    Yes, 10% of the secondary sales fees will be deducted as
                    royalties. A portion of these will be re-invested into
                    marketing to ensure the longevity and momentum of the
                    project throughout the roadmap.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    DO I OWN THE NFT AFTER MINTING IT?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    Yes, you will own all the intellectual properties to your
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    ARE THE BORED 90s GANG NFTS A GOOD INVESTMENT?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WILL THERE BE FLOOR SWEEPS?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
                    Yes. We will regularly use proceeds and royalties to perform
              ...
              >
                ...
                >
                  <Typography color="common.white" variant="body1">
                    ...
                    WHEN WILL I GET MY 3D NFT AIRDROP?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography color="#989898" variant="body1">
